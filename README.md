# [DEPRECATED] Amplitude Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_amplitude`](https://github.com/fivetran/dbt_amplitude) instead, which now contains all models previously found here._
